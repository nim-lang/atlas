...
proc parseNimbleFile*(nc: var NimbleContext;
  ...
  result = NimbleRelease(
    ...
    skipDirs: nimbleInfo.skipDirs,
    skipFiles: nimbleInfo.skipFiles,
    skipExt: nimbleInfo.skipExt,
    installDirs: nimbleInfo.installDirs,
    installFiles: nimbleInfo.installFiles,
    installExt: nimbleInfo.installExt,
    bin: nimbleInfo.bin,
